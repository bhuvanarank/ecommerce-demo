...
<div class="container gap30">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <form id="product-form" method="POST" action="{{ url('/update-products') }}" enctype="multipart/form-data"> 
                      @csrf
                      <div class="row">
                      ...
                      <div class="form-group col-sm-6 col-lg-6 col-md-12">
                          <label> Price </label>
                          <input type="text" name="price" id="price" value="{{number_format($product->price / 100, 2)}}" class="form-control" required="" onkeypress="return event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)" maxlength="8">
                      ...
                      <div class="form-group col-sm-4 col-lg-4 col-md-12">
                          <label> Image </label>
                          <input type="file" name="product_image" id="product_image" value="" class="form-control">
                          <input type="hidden" name="product_image_hid" value="{{$product->image}}">

                          <span id="err_product_image" class="error"></span>
                      </div>

                      <div class="form-group col-sm-2 col-lg-2 col-md-12 md-text-right">
                        <a href="{{asset('uploads/products')}}/{{$product->image}}" target="_blank"><img src="{{asset('uploads/products')}}/{{$product->image}}" height="60px;"></a>
                      </div>
